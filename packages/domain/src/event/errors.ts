...
export class EventNotFoundError extends MempError {
  constructor(id: string) {
    super("EVENT_NOT_FOUND", `Event nicht gefunden: ${id}`, 404, { id });
  }
}

export class InvalidEventStatusTransitionError extends MempError {
...
export class InvalidEventDatesError extends MempError {
  constructor() {
    super("EVENT_DATES_INVALID", "Das Enddatum muss nach dem Startdatum liegen", 400);
  }
}

export class EventFinalizedError extends MempError {
